...
namespace SentimentModel_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Manvay\Desktop\.Net APi\myMLApp\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=912,NumberOfIterations=192,MinimumExampleCountPerLeaf=20,LearningRate=0.7697204196363819,LabelColumnName=@"col1",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9760521208528806,L1Regularization=2E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=183}))      
